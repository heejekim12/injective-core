...
const (
	RiskMode_RISK_MODE_UNSPECIFIED RiskMode = 0
	RiskMode_RISK_MODE_ISOLATED    RiskMode = 1
	RiskMode_RISK_MODE_CROSS       RiskMode = 2
	RiskMode_RISK_MODE_PORTFOLIO   RiskMode = 3
)

var RiskMode_name = map[int32]string{
	0: "RISK_MODE_UNSPECIFIED",
	1: "RISK_MODE_ISOLATED",
	2: "RISK_MODE_CROSS",
	3: "RISK_MODE_PORTFOLIO",
}

var RiskMode_value = map[string]int32{
	"RISK_MODE_UNSPECIFIED": 0,
	"RISK_MODE_ISOLATED":    1,
	"RISK_MODE_CROSS":       2,
	"RISK_MODE_PORTFOLIO":   3,
}

func (x RiskMode) String() string {
	return proto.EnumName(RiskMode_name, int32(x))
}

func (RiskMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_0b5851fb01a33564, []int{1}
}

type ReservationPolicy int32

const (
	ReservationPolicy_RESERVATION_POLICY_UNSPECIFIED  ReservationPolicy = 0
	ReservationPolicy_RESERVATION_POLICY_FULL_HOLD    ReservationPolicy = 1
	ReservationPolicy_RESERVATION_POLICY_PARTIAL_HOLD ReservationPolicy = 2
	ReservationPolicy_RESERVATION_POLICY_NO_HOLD      ReservationPolicy = 3
)

var ReservationPolicy_name = map[int32]string{
	0: "RESERVATION_POLICY_UNSPECIFIED",
	1: "RESERVATION_POLICY_FULL_HOLD",
	2: "RESERVATION_POLICY_PARTIAL_HOLD",
	3: "RESERVATION_POLICY_NO_HOLD",
}

var ReservationPolicy_value = map[string]int32{
	"RESERVATION_POLICY_UNSPECIFIED":  0,
	"RESERVATION_POLICY_FULL_HOLD":    1,
	"RESERVATION_POLICY_PARTIAL_HOLD": 2,
	"RESERVATION_POLICY_NO_HOLD":      3,
}

func (x ReservationPolicy) String() string {
	return proto.EnumName(ReservationPolicy_name, int32(x))
}

func (ReservationPolicy) EnumDescriptor() ([]byte, []int) {
...
type Params struct {
	...
	InjAuctionMaxCap cosmossdk_io_math.Int `protobuf:"bytes,28,opt,name=inj_auction_max_cap,json=injAuctionMaxCap,proto3,customtype=cosmossdk.io/math.Int" json:"inj_auction_max_cap"` // Deprecated: Do not use.
	...
	PostOnlyModeBlocksAmount uint64 `protobuf:"varint,33,opt,name=post_only_mode_blocks_amount,json=postOnlyModeBlocksAmount,proto3" json:"post_only_mode_blocks_amount,omitempty"`
	...
	// module
	MinPostOnlyModeDowntimeDuration string `protobuf:"bytes,34,opt,name=min_post_only_mode_downtime_duration,json=minPostOnlyModeDowntimeDuration,proto3" json:"min_post_only_mode_downtime_duration,omitempty"`
	// post_only_mode_blocks_amount defines the amount of blocks the post only
	...
	DeprecatedEnforcedRestrictionsContracts []EnforcedRestrictionsContract `protobuf:"bytes,36,rep,name=deprecated_enforced_restrictions_contracts,json=deprecatedEnforcedRestrictionsContracts,proto3" json:"deprecated_enforced_restrictions_contracts"`
	...
	WhiteKnightLiquidators []string `protobuf:"bytes,37,rep,name=white_knight_liquidators,json=whiteKnightLiquidators,proto3" json:"white_knight_liquidators,omitempty"`
	...
	WhiteKnightLiquidatorRewardShareRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,38,opt,name=white_knight_liquidator_reward_share_rate,json=whiteKnightLiquidatorRewardShareRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"white_knight_liquidator_reward_share_rate"`
	// cross_margin_params groups all cross-margin related parameters.
	CrossMarginParams CrossMarginParams `protobuf:"bytes,39,opt,name=cross_margin_params,json=crossMarginParams,proto3" json:"cross_margin_params"`
}
...
func (m *Params) GetPostOnlyModeBlocksAmount() uint64 {
	if m != nil {
		return m.PostOnlyModeBlocksAmount
	}
	return 0
}

func (m *Params) GetMinPostOnlyModeDowntimeDuration() string {
	if m != nil {
		return m.MinPostOnlyModeDowntimeDuration
	}
	return ""
}

func (m *Params) GetPostOnlyModeBlocksAmountAfterDowntime() uint64 {
	if m != nil {
		return m.PostOnlyModeBlocksAmountAfterDowntime
	}
	return 0
}

func (m *Params) GetDeprecatedEnforcedRestrictionsContracts() []EnforcedRestrictionsContract {
	if m != nil {
...
func (m *Params) GetWhiteKnightLiquidators() []string {
	if m != nil {
		return m.WhiteKnightLiquidators
	}
	return nil
}

func (m *Params) GetCrossMarginParams() CrossMarginParams {
	if m != nil {
		return m.CrossMarginParams
	}
	return CrossMarginParams{}
}

type CrossMarginParams struct {
	// positive_upnl_haircut_rate defines the haircut applied to
	// positive unrealized PnL for cross-margin admission checks.
	PositiveUpnlHaircutRate cosmossdk_io_math.LegacyDec `protobuf:"bytes,1,opt,name=positive_upnl_haircut_rate,json=positiveUpnlHaircutRate,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"positive_upnl_haircut_rate"`
	// fees_buffer defines a fixed notional buffer (quote-denom
	// units) subtracted from cross-margin equity calculations.
	FeesBuffer cosmossdk_io_math.LegacyDec `protobuf:"bytes,2,opt,name=fees_buffer,json=feesBuffer,proto3,customtype=cosmossdk.io/math.LegacyDec" json:"fees_buffer"`
	// enabled_quote_denoms defines the quote denoms that are
	// eligible for cross-margin pools.
	EnabledQuoteDenoms []string `protobuf:"bytes,3,rep,name=enabled_quote_denoms,json=enabledQuoteDenoms,proto3" json:"enabled_quote_denoms,omitempty"`
	// perpetual_enabled defines whether perpetual derivative markets
	// are eligible for cross margin.
	PerpetualEnabled bool `protobuf:"varint,4,opt,name=perpetual_enabled,json=perpetualEnabled,proto3" json:"perpetual_enabled,omitempty"`
	// expiry_enabled defines whether expiry futures derivative
	// markets are eligible for cross margin.
	ExpiryEnabled bool `protobuf:"varint,5,opt,name=expiry_enabled,json=expiryEnabled,proto3" json:"expiry_enabled,omitempty"`
	...
	MaxActiveDerivativeMarketsPerPool uint32 `protobuf:"varint,6,opt,name=max_active_derivative_markets_per_pool,json=maxActiveDerivativeMarketsPerPool,proto3" json:"max_active_derivative_markets_per_pool,omitempty"`
	...
	EmergencyPaused bool `protobuf:"varint,7,opt,name=emergency_paused,json=emergencyPaused,proto3" json:"emergency_paused,omitempty"`
}

func (m *CrossMarginParams) Reset()         { *m = CrossMarginParams{} }
func (m *CrossMarginParams) String() string { return proto.CompactTextString(m) }
func (*CrossMarginParams) ProtoMessage()    {}
func (*CrossMarginParams) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5851fb01a33564, []int{2}
}
func (m *CrossMarginParams) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CrossMarginParams) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CrossMarginParams.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CrossMarginParams) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CrossMarginParams.Merge(m, src)
}
func (m *CrossMarginParams) XXX_Size() int {
	return m.Size()
}
func (m *CrossMarginParams) XXX_DiscardUnknown() {
	xxx_messageInfo_CrossMarginParams.DiscardUnknown(m)
}

var xxx_messageInfo_CrossMarginParams proto.InternalMessageInfo

func (m *CrossMarginParams) GetEnabledQuoteDenoms() []string {
	if m != nil {
		return m.EnabledQuoteDenoms
	}
	return nil
}

func (m *CrossMarginParams) GetPerpetualEnabled() bool {
	if m != nil {
...
func (m *CrossMarginParams) GetExpiryEnabled() bool {
	if m != nil {
		return m.ExpiryEnabled
	}
	return false
}

func (m *CrossMarginParams) GetMaxActiveDerivativeMarketsPerPool() uint32 {
	if m != nil {
		return m.MaxActiveDerivativeMarketsPerPool
	}
	return 0
}

func (m *CrossMarginParams) GetEmergencyPaused() bool {
	if m != nil {
		return m.EmergencyPaused
	}
	return false
}
...
func (*DenomMinNotional) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5851fb01a33564, []int{37}
}
...
type SubaccountRiskProfile struct {
	Mode              RiskMode          `protobuf:"varint,1,opt,name=mode,proto3,enum=injective.exchange.v2.RiskMode" json:"mode,omitempty"`
	ReservationPolicy ReservationPolicy `protobuf:"varint,2,opt,name=reservation_policy,json=reservationPolicy,proto3,enum=injective.exchange.v2.ReservationPolicy" json:"reservation_policy,omitempty"`
...
func (m *SubaccountRiskProfile) Reset()         { *m = SubaccountRiskProfile{} }
func (m *SubaccountRiskProfile) String() string { return proto.CompactTextString(m) }
func (*SubaccountRiskProfile) ProtoMessage()    {}
func (*SubaccountRiskProfile) Descriptor() ([]byte, []int) {
	return fileDescriptor_0b5851fb01a33564, []int{38}
}
func (m *SubaccountRiskProfile) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *SubaccountRiskProfile) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SubaccountRiskProfile.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *SubaccountRiskProfile) XXX_Merge(src proto.Message) {
	xxx_messageInfo_SubaccountRiskProfile.Merge(m, src)
}
func (m *SubaccountRiskProfile) XXX_Size() int {
	return m.Size()
}
func (m *SubaccountRiskProfile) XXX_DiscardUnknown() {
	xxx_messageInfo_SubaccountRiskProfile.DiscardUnknown(m)
}

var xxx_messageInfo_SubaccountRiskProfile proto.InternalMessageInfo

func (m *SubaccountRiskProfile) GetMode() RiskMode {
	if m != nil {
		return m.Mode
	}
...
func (m *SubaccountRiskProfile) GetReservationPolicy() ReservationPolicy {
	if m != nil {
		return m.ReservationPolicy
	}
	return ReservationPolicy_RESERVATION_POLICY_UNSPECIFIED
}

func (m *SubaccountRiskProfile) GetCreditLineId() string {
	if m != nil {
...
func init() {
	...
	proto.RegisterEnum("injective.exchange.v2.RiskMode", RiskMode_name, RiskMode_value)
	proto.RegisterEnum("injective.exchange.v2.ReservationPolicy", ReservationPolicy_name, ReservationPolicy_value)
	...
	proto.RegisterType((*CrossMarginParams)(nil), "injective.exchange.v2.CrossMarginParams")
	...
	proto.RegisterType((*SubaccountRiskProfile)(nil), "injective.exchange.v2.SubaccountRiskProfile")
}
...
var fileDescriptor_0b5851fb01a33564 = []byte{
	// 3718 bytes of a gzipped FileDescriptorProto
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.PostOnlyModeBlocksAmount != that1.PostOnlyModeBlocksAmount {
		return false
	}
	if this.MinPostOnlyModeDowntimeDuration != that1.MinPostOnlyModeDowntimeDuration {
		return false
	}
	...
	for i := range this.DeprecatedEnforcedRestrictionsContracts {
		if !this.DeprecatedEnforcedRestrictionsContracts[i].Equal(&that1.DeprecatedEnforcedRestrictionsContracts[i]) {
			return false
		}
	}
	if len(this.WhiteKnightLiquidators) != len(that1.WhiteKnightLiquidators) {
		return false
	}
	for i := range this.WhiteKnightLiquidators {
		if this.WhiteKnightLiquidators[i] != that1.WhiteKnightLiquidators[i] {
			return false
		}
	}
	if !this.WhiteKnightLiquidatorRewardShareRate.Equal(that1.WhiteKnightLiquidatorRewardShareRate) {
		return false
	}
	if !this.CrossMarginParams.Equal(&that1.CrossMarginParams) {
		return false
	}
	return true
}
func (this *CrossMarginParams) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*CrossMarginParams)
	if !ok {
		that2, ok := that.(CrossMarginParams)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if !this.PositiveUpnlHaircutRate.Equal(that1.PositiveUpnlHaircutRate) {
		return false
	}
	if !this.FeesBuffer.Equal(that1.FeesBuffer) {
		return false
	}
	if len(this.EnabledQuoteDenoms) != len(that1.EnabledQuoteDenoms) {
		return false
	}
	for i := range this.EnabledQuoteDenoms {
		if this.EnabledQuoteDenoms[i] != that1.EnabledQuoteDenoms[i] {
			return false
		}
	}
	if this.PerpetualEnabled != that1.PerpetualEnabled {
		return false
	}
	if this.ExpiryEnabled != that1.ExpiryEnabled {
		return false
	}
	if this.MaxActiveDerivativeMarketsPerPool != that1.MaxActiveDerivativeMarketsPerPool {
		return false
	}
	if this.EmergencyPaused != that1.EmergencyPaused {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	{
		size, err := m.CrossMarginParams.MarshalToSizedBuffer(dAtA[:i])
		if err != nil {
			return 0, err
		}
		i -= size
	...
	dAtA[i] = 0xba
	{
		size := m.WhiteKnightLiquidatorRewardShareRate.Size()
		i -= size
		if _, err := m.WhiteKnightLiquidatorRewardShareRate.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintExchange(dAtA, i, uint64(size))
	}
	...
	i--
	dAtA[i] = 0xb2
	if len(m.WhiteKnightLiquidators) > 0 {
		for iNdEx := len(m.WhiteKnightLiquidators) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.WhiteKnightLiquidators[iNdEx])
			copy(dAtA[i:], m.WhiteKnightLiquidators[iNdEx])
			i = encodeVarintExchange(dAtA, i, uint64(len(m.WhiteKnightLiquidators[iNdEx])))
			i--
			dAtA[i] = 0x2
			i--
			dAtA[i] = 0xaa
	...
	if len(m.DeprecatedEnforcedRestrictionsContracts) > 0 {
		for iNdEx := len(m.DeprecatedEnforcedRestrictionsContracts) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DeprecatedEnforcedRestrictionsContracts[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.MinPostOnlyModeDowntimeDuration) > 0 {
		i -= len(m.MinPostOnlyModeDowntimeDuration)
		copy(dAtA[i:], m.MinPostOnlyModeDowntimeDuration)
		i = encodeVarintExchange(dAtA, i, uint64(len(m.MinPostOnlyModeDowntimeDuration)))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x92
	}
	if m.PostOnlyModeBlocksAmount != 0 {
		i = encodeVarintExchange(dAtA, i, uint64(m.PostOnlyModeBlocksAmount))
		i--
		dAtA[i] = 0x2
		i--
		dAtA[i] = 0x88
...
func (m *CrossMarginParams) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CrossMarginParams) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CrossMarginParams) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.EmergencyPaused {
		i--
		if m.EmergencyPaused {
			dAtA[i] = 1
		} else {
	...
	if m.MaxActiveDerivativeMarketsPerPool != 0 {
		i = encodeVarintExchange(dAtA, i, uint64(m.MaxActiveDerivativeMarketsPerPool))
		i--
		dAtA[i] = 0x30
	}
	if m.ExpiryEnabled {
	...
	if len(m.EnabledQuoteDenoms) > 0 {
		for iNdEx := len(m.EnabledQuoteDenoms) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.EnabledQuoteDenoms[iNdEx])
			copy(dAtA[i:], m.EnabledQuoteDenoms[iNdEx])
			i = encodeVarintExchange(dAtA, i, uint64(len(m.EnabledQuoteDenoms[iNdEx])))
			i--
			dAtA[i] = 0x1a
		}
	}
	{
		size := m.FeesBuffer.Size()
		i -= size
		if _, err := m.FeesBuffer.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintExchange(dAtA, i, uint64(size))
	}
	...
	dAtA[i] = 0x12
	{
		size := m.PositiveUpnlHaircutRate.Size()
		i -= size
		if _, err := m.PositiveUpnlHaircutRate.MarshalTo(dAtA[i:]); err != nil {
			return 0, err
		}
		i = encodeVarintExchange(dAtA, i, uint64(size))
	}
...
func (m *SubaccountRiskProfile) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *SubaccountRiskProfile) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *SubaccountRiskProfile) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.CreditLineId) > 0 {
		...
		i = encodeVarintExchange(dAtA, i, uint64(len(m.CreditLineId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.ReservationPolicy != 0 {
		i = encodeVarintExchange(dAtA, i, uint64(m.ReservationPolicy))
		i--
		dAtA[i] = 0x10
	}
	if m.Mode != 0 {
		i = encodeVarintExchange(dAtA, i, uint64(m.Mode))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Params) Size() (n int) {
	...
	n += 2 + l + sovExchange(uint64(l))
	if m.PostOnlyModeBlocksAmount != 0 {
		n += 2 + sovExchange(uint64(m.PostOnlyModeBlocksAmount))
	}
	l = len(m.MinPostOnlyModeDowntimeDuration)
	if l > 0 {
		n += 2 + l + sovExchange(uint64(l))
	}
	if m.PostOnlyModeBlocksAmountAfterDowntime != 0 {
	...
	if len(m.DeprecatedEnforcedRestrictionsContracts) > 0 {
		for _, e := range m.DeprecatedEnforcedRestrictionsContracts {
			l = e.Size()
			n += 2 + l + sovExchange(uint64(l))
		}
	}
	if len(m.WhiteKnightLiquidators) > 0 {
		for _, s := range m.WhiteKnightLiquidators {
			l = len(s)
			n += 2 + l + sovExchange(uint64(l))
		}
	}
	l = m.WhiteKnightLiquidatorRewardShareRate.Size()
	n += 2 + l + sovExchange(uint64(l))
	l = m.CrossMarginParams.Size()
	n += 2 + l + sovExchange(uint64(l))
	return n
}

func (m *CrossMarginParams) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	l = m.PositiveUpnlHaircutRate.Size()
	n += 1 + l + sovExchange(uint64(l))
	l = m.FeesBuffer.Size()
	n += 1 + l + sovExchange(uint64(l))
	if len(m.EnabledQuoteDenoms) > 0 {
		for _, s := range m.EnabledQuoteDenoms {
			l = len(s)
			n += 1 + l + sovExchange(uint64(l))
		}
	}
	...
	if m.MaxActiveDerivativeMarketsPerPool != 0 {
		n += 1 + sovExchange(uint64(m.MaxActiveDerivativeMarketsPerPool))
	}
	if m.EmergencyPaused {
		n += 2
	}
...
func (m *SubaccountRiskProfile) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.Mode != 0 {
		n += 1 + sovExchange(uint64(m.Mode))
	}
	if m.ReservationPolicy != 0 {
		n += 1 + sovExchange(uint64(m.ReservationPolicy))
	}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 33:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PostOnlyModeBlocksAmount", wireType)
			}
			m.PostOnlyModeBlocksAmount = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExchange
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PostOnlyModeBlocksAmount |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 34:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinPostOnlyModeDowntimeDuration", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MinPostOnlyModeDowntimeDuration = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 35:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field PostOnlyModeBlocksAmountAfterDowntime", wireType)
			}
			m.PostOnlyModeBlocksAmountAfterDowntime = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExchange
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PostOnlyModeBlocksAmountAfterDowntime |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 36:
			...
			m.DeprecatedEnforcedRestrictionsContracts = append(m.DeprecatedEnforcedRestrictionsContracts, EnforcedRestrictionsContract{})
			if err := m.DeprecatedEnforcedRestrictionsContracts[len(m.DeprecatedEnforcedRestrictionsContracts)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 37:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WhiteKnightLiquidators", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.WhiteKnightLiquidators = append(m.WhiteKnightLiquidators, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 38:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field WhiteKnightLiquidatorRewardShareRate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.WhiteKnightLiquidatorRewardShareRate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 39:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CrossMarginParams", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.CrossMarginParams.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CrossMarginParams) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CrossMarginParams: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CrossMarginParams: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PositiveUpnlHaircutRate", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.PositiveUpnlHaircutRate.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FeesBuffer", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.FeesBuffer.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EnabledQuoteDenoms", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.EnabledQuoteDenoms = append(m.EnabledQuoteDenoms, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
		...
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExpiryEnabled", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExpiryEnabled = bool(v != 0)
		case 6:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxActiveDerivativeMarketsPerPool", wireType)
			}
			m.MaxActiveDerivativeMarketsPerPool = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExchange
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxActiveDerivativeMarketsPerPool |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field EmergencyPaused", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *SubaccountRiskProfile) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: SubaccountRiskProfile: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: SubaccountRiskProfile: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReservationPolicy", wireType)
			}
			m.ReservationPolicy = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowExchange
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReservationPolicy |= ReservationPolicy(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
