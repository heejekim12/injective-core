...
const UpgradeVersion = "v1.20.1-beta"
...
func UpgradeSteps() []*upgrades.UpgradeHandlerStep {
	cardanoIBCStep := "Allow Cardano probabilistic IBC client"
	backfillRateLimitOracleTypeStep := "Backfill peggy rate limit oracle type"
	removeDustDelegationsStep := "Remove dust delegations"
	return []*upgrades.UpgradeHandlerStep{
		...
		upgrades.NewUpgradeHandlerStep(
			backfillRateLimitOracleTypeStep,
			UpgradeVersion,
