...
require (
	...
	github.com/InjectiveLabs/metrics/v2 v2.0.0-beta.9
	...
	github.com/smartcontractkit/data-streams-sdk/go v1.2.0
...
replace (
	...
	nhooyr.io/websocket => github.com/nhooyr/websocket v1.8.11
)
